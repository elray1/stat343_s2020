 ...
 * **In class**, we will work on:
    ...
    * Example of bootstrap for estimating the distribution of the mean for a Poisson distribution
        ...
        * R Markdown document for example: [Rmd](materials/20200410_bootstrap/20200410_bootstrap_example.Rmd)
')
```
 ...
 * **In class**, we will work on bootstrap confidence intervals
    * Materials used throughout all videos today and next class
        ...
        * R markdown file used to generate handout: [Rmd](materials/20200413_bootstrap_CIs/20200413_bootstrap_CIs.Rmd)
...
#### Fri, Apr 17
 * **In class**, we will work on:
    * Introduce framework for hypothesis testing
 * **After class**, please:
')
```
