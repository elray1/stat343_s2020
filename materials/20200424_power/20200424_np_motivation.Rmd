 ...
 * **Shade in the area corresponding to the probability of a Type I Error**
 * **Shade in the area corresponding to the power of the test**
...
```{r, echo = FALSE, message=FALSE, cache = TRUE, fig.height = 1.5, fig.width = 7}
x_grid_1 <- seq(from = 20.617, to = 21.019, length = 101)
...
x_grid_2 <- seq(from = 24.930, to = 25.070, length = 101)
...
x_grid_3 <- seq(from = 28.981, to = 29.383, length = 101)

region_to_shade3 <- data.frame(
  x = c(x_grid_3[1], x_grid_3, tail(x_grid_3, 1)),
  y = c(0, dnorm(x_grid_3, mean = 25, sd = sqrt(5), log = FALSE), 0)
)
